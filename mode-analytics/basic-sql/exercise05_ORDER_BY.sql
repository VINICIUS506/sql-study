...
-- Exercises Goals: Get used to the ORDER BY clause.
-- ===================================================================
...
SELECT *   
  FROM tutorial.billboard_top_100_year_end
WHERE year_rank BETWEEN 10 AND 20 -- Select the specific rank range
  AND year IN (1993, 2003, 2013) -- Filter correct years
